...
## boots
give @a[tag=dd] minecraft:leather_boots{display:{Name:"{\"text\":\"Daredevil's Boots\",\"color\":\"dark_red\",\"bold\":\"true\"}",color:3080192},HideFlags:63,Unbreakable:1b,Enchantments:[{id:"minecraft:protection",lvl:3},{id:"minecraft:feather_falling",lvl:5},{id:"minecraft:blast_protection",lvl:5},{id:"minecraft:projectile_protection",lvl:10}]} 1

## batons
give @a[tag=dd] minecraft:shield{display:{Name:"{\"text\":\"Baton\",\"color\":\"dark_red\",\"bold\":\"true\"}",Lore:["Billy club isn't a cool enough name."]},HideFlags:63,Unbreakable:1b,Damage:7,Enchantments:[{id:"minecraft:sharpness",lvl:10},{id:"minecraft:knockback",lvl:1},{id:"minecraft:looting",lvl:3}]} 2